...
int main(int argc, char** argv)
{
    ...
    //region Road
    //Road[0/1]-------------------------------------------------------------
    auto r0 = map.AddRoad({-229.22, -104.96, 25.719});
    ...
    r0->AddSignal(7.53, 5.42, 5.9, Angle(25.719), "SIG", "0101");
    r0->AddSignal(8.47, 3.42, 5.9, Angle(25.719), "SIG", "0111");

    auto r1 = map.AddRoad({-40.31, -13.43, 205.719});

    auto r1_s0 = r1->AddSection({-229.42, -104.59, 205.719});
    ...
    r3_s3->AddLane(1, 3.75, 2.9, {1}, {1});
    r3_s3->AddLane(2, 3.75, 5.9, {1}, {2});

    auto r3_s4 = r3->AddSection({-5.58, -27.31, 123.2875});
    r3_s4->AddLane(1, 2.9, 2.9, {1}, {});
    r3_s4->AddLane(2, 5.9, 5.9, {2}, {});

    r3->AddSignal(-23.99, 5.17, 4.0, Angle(123.2875), "SIG", "1011");

    //Road[4/5]-------------------------------------------------------------
    auto r4 = map.AddRoad({102.28, -157.03, 29.2014});

    auto r4_s0 = r4->AddSection({131.77, -140.60, 29.2014});
    r4_s0->AddLane( 1, 2.9, 2.9, {}, {1});

    auto r4_s1 = r4->AddSection({146.25, -131.22, 29.2014}, 10.0, 10.0);
    r4_s1->AddLane( 1, 2.9, 3.75, {1}, {1});

    auto r4_s2 = r4->AddSection({198.86, -101.11, 29.2014});
    r4_s2->AddLane( 1, 3.75, 3.75, {1}, {1, 2, 3});

    auto r4_s3 = r4->AddSection({237.64, -76.93, 29.2014}, 15.0, 15.0);
    r4_s3->AddLane( 1, 3.75, 2.9, {1}, {1});
    r4_s3->AddLane( 2, 3.75, 5.9, {1}, {2});
    r4_s3->AddLane( 3, 3.75, 8.8, {1}, {3});

    auto r4_s4 = r4->AddSection({253.27, -68.48, 29.2014});
    r4_s4->AddLane( 1, 2.9, 2.9, {1}, {});
    r4_s4->AddLane( 2, 5.9, 5.9, {2}, {});
    r4_s4->AddLane( 3, 8.8, 8.8, {3}, {});

    r4->AddSignal(314.374, -37.4881, 5.9, Angle(29.2014), "SIG", "1101");
    r4->AddSignal(315.364, -39.1981, 5.9, Angle(29.2014), "SIG", "0010");

    auto r5 = map.AddRoad({253.27, -68.48, 209.2014});

    auto r5_s0 = r5->AddSection({237.64, -76.93, 209.2014});
    r5_s0->AddLane(1, 2.9, 2.9, {}, {1});

    auto r5_s1 = r5->AddSection({198.86, -101.11, 209.2014}, 15.0, 15.0);
    r5_s1->AddLane(1, 2.9, 3.75, {1}, {1});

    auto r5_s2 = r5->AddSection({146.25, -131.22, 209.2014});
    r5_s2->AddLane(1, 3.75, 3.75, {1}, {1, 2});

    auto r5_s3 = r5->AddSection({131.77, -140.60, 209.2014}, 10.0, 10.0);
    r5_s3->AddLane(1, 3.75, 2.9, {1}, {1});
    r5_s3->AddLane(2, 3.75, 5.9, {1}, {2});

    auto r5_s4 = r5->AddSection({102.28, -157.03, 209.2014});
    r5_s4->AddLane(1, 2.9, 2.9, {1}, {});
    r5_s4->AddLane(2, 5.9, 5.9, {2}, {});

    //Road[6/7]-------------------------------------------------------------
    auto r6 = map.AddRoad({261.36, -35.95, 126.342});

    auto r6_s0 = r6->AddSection({185.59, 66.66, 126.342});
    r6_s0->AddLane( 1, 3.78, 3.78, {}, {});
    r6_s0->AddLane( 2, 7.26, 7.26, {}, {});
    r6_s0->AddLane( 3, 10.36, 10.36, {}, {});

    r6->AddSignal(155.98, 107.59, 5.9, Angle(126.342), "SIG", "1000");
    r6->AddSignal(157.69, 108.56, 5.9, Angle(126.342), "SIG", "0011");

    auto r7 = map.AddRoad({185.99, 66.69, -53.6531});
    ...
    r7->AddSignal(290.11, -85.98, 5.9, Angle(-53.6531), "SIG", "1101");
    r7->AddSignal(288.32, -87.21, 5.9, Angle(-53.6531), "SIG", "0010");
    ...
    r8->AddSignal(209.943, 110.82, 5.9, Angle(25.7603), "SIG", "1000");
    r8->AddSignal(210.923, 108.89, 5.9, Angle(25.7603), "SIG", "0111");
    ...
    r9->AddSignal(-43.856, -12.1609, 5.9, Angle(-154.28), "SIG", "1000");
    r9->AddSignal(-45.046, -10.3009,  5.9, Angle(-154.28), "SIG", "0100");

    //Road[10/11]-------------------------------------------------------------
    auto r10 = map.AddRoad({191.04, 97.12, 27.71});

    auto r10_s0 = r10->AddSection({219.94, 112.28, 27.71});
    r10_s0->AddLane(1, 2.9, 2.9, {}, {1});

    auto r10_s1 = r10->AddSection({247.09, 128.20, 27.71}, 18.0, 18.0);
    r10_s1->AddLane(1, 2.9, 4.5, {1}, {1});
    ...
    r11_s3->AddLane(1, 4.0, 2.9, {1}, {1});
    r11_s3->AddLane(2, 4.0, 5.9, {1}, {2});

    auto r11_s4 = r11->AddSection({191.04, 97.12, -152.291});
    r11_s4->AddLane(1, 2.9, 2.9, {1}, {});
    r11_s4->AddLane(2, 5.9, 5.9, {2}, {});
    ...
    r13_s3->AddLane(1, 3.75, 2.9, {1}, {1});
    r13_s3->AddLane(2, 3.75, 5.9, {1}, {2});
    r13_s3->AddLane(3, 3.75, 8.8, {1}, {3});

    auto r13_s4 = r13->AddSection({300.35, -48.52, -150.996});
    r13_s4->AddLane(1, 2.9, 2.9, {1}, {});
    r13_s4->AddLane(2, 5.9, 5.9, {2}, {});
    r13_s4->AddLane(3, 8.8, 8.8, {3}, {});

    r13->AddSignal(249.52, -73.40, 5.9, Angle(-150.996), "SIG", "1101");
    r13->AddSignal(248.53, -71.63, 5.9, Angle(-150.996), "SIG", "0010");

    //Road[14/15]-------------------------------------------------------------

    auto r14 = map.AddRoad({379.61, -208.74, 124.063});

    auto r14_s0 = r14->AddSection({292.96, -80.82, 124.063});
    r14_s0->AddLane(1, 3.78, 3.78, {}, {});
    r14_s0->AddLane(2, 7.26, 7.26, {}, {});
    r14_s0->AddLane(3, 10.36, 10.36, {}, {});

    r14->AddSignal(263.43, -30.72, 5.9, Angle(124.063), "SIG", "1101");
    r14->AddSignal(265.23, -29.41, 5.9, Angle(124.063), "SIG", "0010");

    auto r15 = map.AddRoad({292.54, -80.90, -55.9177});
    ...
    r17_s1->AddLane(1, 4.5, 2.9, {1}, {1});
    r17_s1->AddLane(2, 4.5, 5.9, {1}, {2});

    auto r17_s2 = r17->AddSection({498.68, 50.94, 139.125});
    r17_s2->AddLane(1, 2.9, 2.9, {1}, {});
    r17_s2->AddLane(2, 5.9, 5.9, {2}, {});
    ...
    r18_s0->AddLane(1, 2.9, 2.9, {}, {1});

    auto r18_s1 = r18->AddSection({470.57, -187.08, 29.437}, 15.9, 12.0);
    r18_s1->AddLane(1, 2.9, 4.0, {1}, {1});
    ...
    r18_s3->AddLane(1, 4.0, 2.9, {1}, {1});
    r18_s3->AddLane(2, 4.0, 5.9, {1}, {2});

    auto r18_s4 = r18->AddSection({632.79, -93.95, 29.437});
    r18_s4->AddLane(1, 2.9, 2.9, {1}, {});
    r18_s4->AddLane(2, 5.9, 5.9, {2}, {});
    ...
    r19_s1->AddLane(1, 2.9, 3.75, {1}, {1});

    auto r19_s2 = r19->AddSection({470.57, -187.08, -150.563});
    r19_s2->AddLane(1, 3.75, 3.75, {1}, {1, 2, 3});

    auto r19_s3 = r19->AddSection({443.66, -204.82, -150.563}, 12.0, 15.9);
    r19_s3->AddLane(1, 3.75, 2.75, {1}, {1});
    r19_s3->AddLane(2, 3.75, 5.7, {1}, {2});
    r19_s3->AddLane(3, 3.75, 8.8, {1}, {3});

    auto r19_s4 = r19->AddSection({417.10, -220.23, -150.563});
    r19_s4->AddLane(1, 2.75, 2.75, {1}, {});
    r19_s4->AddLane(2, 5.7, 5.7, {2}, {});
    r19_s4->AddLane(3, 8.8, 8.8, {3}, {});
    ...
    r20_s3->AddLane(1, 3.75, 2.9, {1}, {1});
    r20_s3->AddLane(2, 3.75, 5.9, {1}, {2});
    r20_s3->AddLane(3, 3.75, 8.8, {1}, {3});

    auto r20_s4 = r20->AddSection({369.39, -240.99, 29.337});
    r20_s4->AddLane(1, 2.9, 2.9, {1}, {});
    r20_s4->AddLane(2, 5.9, 5.9, {2}, {});
    r20_s4->AddLane(3, 8.8, 8.8, {3}, {});

    auto r21 = map.AddRoad({369.39, -240.99, -150.663});

    auto r21_s0 = r21->AddSection({337.63, -259.21, -150.663});
    r21_s0->AddLane(1, 2.9, 2.9, {}, {1});

    auto r21_s1 = r21->AddSection({312.28, -276.52, -150.663}, 15.0, 15.0);
    r21_s1->AddLane(1, 2.9, 3.75, {1}, {1});
    ...
    r21_s3->AddLane(1, 3.75, 2.9, {1}, {1});
    r21_s3->AddLane(2, 3.75, 5.9, {1}, {2});

    auto r21_s4 = r21->AddSection({217.07, -331.82, -150.663});
    r21_s4->AddLane(1, 2.9, 2.9, {1}, {});
    r21_s4->AddLane(2, 5.9, 5.9, {2}, {});
    ...
    r24_s3->AddLane(1, 3.75, 2.9, {1}, {1});
    r24_s3->AddLane(2, 3.75, 5.9, {1}, {2});

    auto r24_s4 = r24->AddSection({191.13, -323.29, -56.9236});
    r24_s4->AddLane(1, 2.9, 2.9, {1}, {});
    r24_s4->AddLane(2, 5.9, 5.9, {2}, {});

    auto r25 = map.AddRoad({191.13, -323.29, 122.9764});

    auto r25_s0 = r25->AddSection({173.65, -296.34, 122.9764});
    r25_s0->AddLane(1, 2.9, 2.9, {}, {1});

    auto r25_s1 = r25->AddSection({159.60, -277.22, 122.9764}, 15.0, 15.0);
    r25_s1->AddLane(1, 2.9, 3.75, {1}, {1});

    auto r25_s2 = r25->AddSection({124.77, -224.02, 122.9764});
    r25_s2->AddLane(1, 3.75, 3.75, {1}, {1, 2});

    auto r25_s3 = r25->AddSection({112.02, -207.23, 122.9764}, 10.0, 10.0);
    r25_s3->AddLane(1, 3.75, 2.9, {1}, {1});
    r25_s3->AddLane(2, 3.75, 5.9, {1}, {2});

    auto r25_s4 = r25->AddSection({95.14, -181.16, 122.9764});
    r25_s4->AddLane(1, 2.9, 2.9, {1}, {});
    r25_s4->AddLane(2, 5.9, 5.9, {2}, {});
    ...
    r27_s3->AddLane(1, 3.75, 2.9, {1}, {1});
    r27_s3->AddLane(2, 3.75, 5.9, {1}, {2});

    auto r27_s4 = r27->AddSection({-99.93, -269.22, -150.851});
    r27_s4->AddLane(1, 2.9, 2.9, {1}, {});
    r27_s4->AddLane(2, 5.9, 5.9, {2}, {});
    ...
    r29_s3->AddLane(1, 3.75, 2.9, {1}, {1});
    r29_s3->AddLane(2, 3.75, 5.9, {1}, {2});

    auto r29_s4 = r29->AddSection({209.43, -356.33, 123.2345});
    r29_s4->AddLane(1, 2.9, 2.9, {1}, {});
    r29_s4->AddLane(2, 5.9, 5.9, {2}, {});
    ...
    auto r38_s1 = r38->AddSection({235.96, -608.58, -149.223}, 5.9, 5.9);
    r38_s1->AddLane(1, 3.3, 2.9, {1}, {1});
    r38_s1->AddLane(2, 6.6, 5.9, {2}, {2});
    r38_s1->AddLane(3, 10.0, 8.8, {3}, {3});
    r38_s1->AddLane(4, 10.0, 12.0, {3}, {4});

    auto r38_s2 = r38->AddSection({197.67, -630.61, -149.223});
    r38_s2->AddLane(1, 2.9, 2.9, {1}, {});
    r38_s2->AddLane(2, 5.9, 5.9, {2}, {});
    r38_s2->AddLane(3, 8.8, 8.8, {3}, {});
    ...
    auto r41_s4 = r41->AddSection({547.87, -224.35, 150.031}, 2.9, 2.9);
    ...
    auto r41_s9 = r41->AddSection({579.24, -295.00, 259.331}, 8.8, 8.8);
