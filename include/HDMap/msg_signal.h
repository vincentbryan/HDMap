...
struct MD5Sum< ::HDMap::msg_signal_<ContainerAllocator> >
{
  ...
  {
    return "75a7162de655556280ca54e519be42df";
  }

  static const char* value(const ::HDMap::msg_signal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x75a7162de6555562ULL;
  static const uint64_t static_value2 = 0x80ca54e519be42dfULL;
};
