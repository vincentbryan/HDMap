...
namespace ros {
    namespace serialization {
        ...
        template<class ContainerAllocator>
        struct Serializer<::HDMap::srv_map_dataRequest_<ContainerAllocator> > {
...
namespace ros {
    namespace message_operations {
        ...
        struct Printer<::HDMap::srv_map_dataRequest_<ContainerAllocator> > {
            ...
            static void
            stream(Stream &s, const std::string &indent, const ::HDMap::srv_map_dataRequest_<ContainerAllocator> &v) {
                s << indent << "type: ";
